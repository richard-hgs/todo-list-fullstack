...
export default function RegisterForm() {
  ...
  const isRegistered = useAppSelector(
    (state) => state?.auth?.isRegistered ?? false
  );
  const isCodeResend = useAppSelector(
    (state) => state?.auth?.isCodeResend ?? false
  );
  ...
  React.useEffect(() => {
    if (isRegistered) {
      setSuccess({
        ...
        open: true,
        message:
          "Código de ativação enviado para o seu e-mail. Verifique o spam.",
        onDismiss: () => {
  ...
  React.useEffect(() => {
    if (isCodeResend) {
      setSuccess({
        ...
        open: true,
        message:
          "Código de ativação reenviado para o seu e-mail. Verifique o spam.",
        onDismiss: () => {
          navigateToSignInScreen();
        },
      });
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        ...
        >
          ...
          <div>
            ...
            <div className="mt-2">
              ...
              {errors.password && (
                <p className="text-red-400 text-sm mt-2">Senha inválida</p>
              )}
            </div>
          </div>
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-500">
          ...
          <a
            ...
            onClick={() => onResendEmailActivation()}
          >
            Reenviar o e-mail
          </a>
        </p>
